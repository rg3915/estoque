...
def estoque_entrada_detail(request, pk):
    ...
    context = {"object": obj, "url_list": "estoque:estoque_entrada_list"}
    return render(request, template_name, context)
...
def estoque_saida_detail(request, pk):
    ...
    context = {"object": obj, "url_list": "estoque:estoque_saida_list"}
    return render(request, template_name, context)
...
def dar_baixa_no_estoque_com_protocolo_de_entrega(request, pk):
    ...
    estoque_saida = EstoqueSaida.objects.create(funcionario=request.user, movimento="s")
